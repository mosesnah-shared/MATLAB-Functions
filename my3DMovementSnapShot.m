...
for i = 1 : 3
   ...
   rawData{ i } = myTxtParse( ['data_log_sparse_', num2str( i ), '.txt']  );
...
for i = 1 : length( tIdx )
    ...
    p2 = scatter3( rawData{ idx }.geomXPositions( 2:4, tIdx( idx, i ) ), ...
                   rawData{ idx }.geomYPositions( 2:4, tIdx( idx, i ) ), ...
                   rawData{ idx }.geomZPositions( 2:4, tIdx( idx, i ) ), 300, ... 
    ...
    p4 = scatter3( rawData{ idx }.geomXPositions( 5:end, tIdx( idx, i ) ), ...
                   rawData{ idx }.geomYPositions( 5:end, tIdx( idx, i ) ), ...
                   rawData{ idx }.geomZPositions( 5:end, tIdx( idx, i ) ), 30, ... 
...
set(a,'LineWidth',1.5,'TickLength',[0.025 0.025]);
